package com.zero.library.widget.nineimg;
...
public class NineGridImageView<T> extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mImgDataList != null && mImgDataList.size() > 0) {
            ...
            //单行，图片为长方形
            height = (mGridSize / 5 * 4) * mRowCount + mGap * (mRowCount - 1) + getPaddingTop() + getPaddingBottom();
        }
    ...
    private void layoutForNoSpanChildrenView(int childrenCount) {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            bottom = (top + mGridSize) / 5 * 4;//top + mGridSize;//正方形
