...
import com.zero.library.widget.viewpager.banner.transformer.BGAPageTransformer;
import com.zero.library.widget.viewpager.banner.transformer.TransitionEffect;
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mPointSize = DensityUtils.dp2px(getContext(), 6);
        mPointLeftRightMargin = DensityUtils.dp2px(context, 6);
        ...
        mPointContainerBackgroundDrawable = new ColorDrawable(Color.TRANSPARENT);
    ...
    private void initIndicator() {
        if (mPointRealContainerLl != null) {
            ...
            if (mIsNeedShowIndicatorOnOnlyOnePage || (!mIsNeedShowIndicatorOnOnlyOnePage && mViews.size() > 1)) {
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(this.mPointSize, this.mPointSize);
